...
/** Hilt module that provides singleton-level dependencies. */
...
object AppModule {
  ...
  fun provideDownloadRepository(
    ...
    return DownloadRepository(context, scope, dispatcher)
  }
  ...
  @Singleton
  @Provides
  fun provideGalleryLifecycleProvider(): GalleryLifecycleProvider {
